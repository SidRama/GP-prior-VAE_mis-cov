...
def minibatch_KLD_upper_bound_iter(covar_module0, covar_module1, likelihood, latent_dim, m, H, train_xt, mu, log_v, z, P,
...
def minibatch_sgd(covar_module, likelihood, latent_dim, m, H, train_xt, mu, log_v, z, P_batch, natural_gradient, eps, N):
    """
    KL divergence using mini-batching and stochastic gradient descent.
    See L-VAE supplementary material.
