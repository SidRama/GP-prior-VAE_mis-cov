...
class ModelArgs:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--csv_file_label_unmasked', type=str, help='Name of unmasked label file',
                                 required=False)
        ...
        self.parser.add_argument('--dataset_type', required=False, choices=['RotatedMNIST', 'HealthMNIST', 'SimpleMNIST', 'Physionet', 'Physionet2019'],
                                 help='Type of dataset being used.')
        self.parser.add_argument('--latent_dim', type=int, default=2, help='Number of latent dimensions')
        self.parser.add_argument('--latent_dim_cov', type=int, default=2, help='Number of latent dimensions in cov VAE')
        ...
        self.parser.add_argument('--epochs_cov', type=int, default=1000, help='Number of epochs for covariate training')
        ...
        self.parser.add_argument('--file_num', type=str)
        ...
        self.parser.add_argument('--labels_idx', type=ast.literal_eval, help='Indices of the labels')
...
class VAEArgs:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--csv_file_test_label', type=str, help='Name of test label file', required=False)
        self.parser.add_argument('--test_mask_file', type=str, help='Name of test mask file', default=None)
        self.parser.add_argument('--dataset_type', required=False, choices=['RotatedMNIST', 'HealthMNIST', 'Physionet', 'Physionet2019'],
                                 help='Type of dataset being used.')
        self.parser.add_argument('--latent_dim', type=int, default=2, help='Number of latent dimensions')
        self.parser.add_argument('--hidden_dim', type=int, default=64, help='Number of hidden dimensions for RNN')
        self.parser.add_argument('--id_covariate', type=int, help='Index of ID (unique identifier) covariate')
